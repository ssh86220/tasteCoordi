...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<form action="tsmainSearchStyle" method="POST">
	...
	<form action="tsmainSearchCategory" method="POST">
		<fieldset>
			<h3>아이템검색1</h3>
	...
	<form action="tsmainSearchColor" method="POST">
		<fieldset>
			</select> <label>색상필드</label><select name="color">
