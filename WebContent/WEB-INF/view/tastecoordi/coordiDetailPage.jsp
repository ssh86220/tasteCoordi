...
<link href="../resource/css/coordidetail.css" type="text/css"
	rel="stylesheet" />
...
<body id="body">
	...
	<aside id="aside">
		...
		<ul>
			...
			<li><a href=""><img
					src="../resource/image/css/login-icon.png" alt="Log Out"></a></li>
			<li><a href=""><img
					src="../resource/image/css/coordi-icon.png" alt="Coordi"></a></li>
			<li><a href=""><img
					src="../resource/image/css/search-icon.png" alt="Serch"></a></li>
			<li><a href=""><img src="../resource/image/css/q&a-icon.png"
					alt="Q&A"></a></li>
			<li><a href=""><img
	...
	<section>
		...
		<main id="main"> 
		<a href="coordiDetailPage?c=${codi.Code}">
			<h1 class="Hidden">코디 상세페이지</h1> <!-- -----------------1. 코디 상세페이지 상단 -------------------->
			<!-- ---------2. 상단 좌측 코디 이미지 -------------------->
			...
			</section> <!------------2. 상단 좌측 코디 이미지 끝 --------------------> <!-- ---------2. 상단 우측 칸 ----------------->
			<section id="coordi-contents">
				...
				<nav id="coordi-like">
					...
					<ul>
						...
						<li><a href=""><img
								src="${ctxName}/resource/image/profile/${codi.image}"
								width=200px alt="프로필 사진"></a></li>

						<!-- 팔로우 카운트 추가 -->
						<li id="sns"><a href=""><img
								src="../resource/image/css/follow.jpg" alt="팔로우 이미지"></a></li>

						<!-- 좋아요 카운트 추가 팝업창, 마이페이지로 이동 -->
						<li id="sns"><a href=""
							onclick="javascript:window.open('likePop.jsp','popup','scrollbars=no, resizable=no, width=300,height=200')"
							; returnfalse"> <img src="../resource/image/css/like.JPG"
								alt="좋아요 이미지">
			...
			</section> <!-- ---------2.코디 상세페이지 우측 칸 끝----------------------> <!-- ---------1.코디 상세페이지 하단---------------------->
			<div id="clear"></div>
			<section>
				<nav id="overview">
					<h1>
						<img src="../resource/image/css/overview.jpg" alt="Overview">
					</h1>
				...
				<nav id="coordi-item">
					<h1>
						<img src="../resource/image/css/coordi-item.jpg"
							alt="해당 코디에 사용된 아이템">
					</h1>
					...
					<ul>
						...
						<c:forEach var="cl" items="${clotheslist}">
							<li>${cl.clothesCode}<img
								src="${ctxName}/resource/image/clothes/${cl.image}"
								width="200px" alt="이미지1">
							</li>
							<%-- <li>${cl.image}</li> --%>
						</c:forEach>
